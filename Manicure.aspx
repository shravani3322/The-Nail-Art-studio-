<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manicure.aspx.cs" Inherits="finalnailart05.Manicure" %>
...
<body>
    ...
    <h1 style="text-align:center; margin-top:20px;">Manicure Services</h1>

    <div class="services">
       <asp:Repeater ID="RepeaterManicure" runat="server">
    <ItemTemplate>
