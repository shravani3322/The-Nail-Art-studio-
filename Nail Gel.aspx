<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NailGel.aspx.cs" Inherits="finalnailart05.NailGel" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Nail Gel Services - Nail Art Studio</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <h1 style="text-align:center; margin-top:20px;">Nail Gel Services</h1>

    <div class="services">
        <asp:Repeater ID="RepeaterNailGel" runat="server">
    <ItemTemplate>
